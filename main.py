...
def attack(char_name: str, char_class: str) -> str:
    """Возврат значения нанесенного урона в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возврат значения урона, которое блокировал персонаж."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возврат значения специального умения персонажа."""
    if char_class == 'warrior':
